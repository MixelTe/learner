...
export const data = [
    new TestItemSelfCheck(0, DBc("Пол-, полу"), DBc()
        ...
        .ul("Заглавной буквы - пол-Москвы, пол-России", "Гласной буквы - пол-яблока, пол-огурца", "Буквы л - пол-лимона, пол-литра")
        .title("Слитно")
    ...
    new TestItemSelfCheck(1, DBc("Дефиз в сложных словах"), DBc()
        .title("Через дефиз")
        .text("Если образовано из сочинительных словосочетаний", "Диван-кровать - диван и кровать", "Шиномонтаж - монтаж шин").br()
        .text("Оттенки и стороны света", "Желто-зелёный, тёмно-синий, юго-запад").br()
        .text("Звания, начинающиеся с вице-, экс-, контр-", "Вице-президент, экс-чемпион, контр-генерал", "(контригра - не звание)")),
    new TestItemSelfCheck(2, DBc("Дефиз в наречиях"), DBc()
        .title("Через дефиз")
        .text("С частицами кое-, -то, -либо, -нибудь", "Всё-таки, где-то, как-либо, кое-как").br()
        .text("По-...ому,ему,и,цки,ски", "По-твоЕМУ, по-туреЦКИ, по-латынИ").br()
        .text("в-,во-...ых,их", "Во-первых, в-третьих").br()
        .text("Образованные повтором слова или синонима", "тихо-тихо, еле-еле", "тихо-смирно, сегодня-завтра")),
