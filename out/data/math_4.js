...
export const math_4 = [
    ...
    new TestItemSelfCheck(1, DBc().text("Уравнение касательной к графику функции ").formula(createFormulas("y = f(x)")).text(" в точке ").formula(createFormulas("x_0")), createFormulas("y = f(x_0) + f'(x_0)(x - x_0)")),
