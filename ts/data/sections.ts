...
export const Sections: Section[] = [
	{
		...
		themes: [
			...
			// { id: "ru_10p", name: "№10 Практика", color: themes.blue, items: ru_10p, onlyAnswerInQList: true },
			{ id: "ru_11", name: "№11 Правописание суффиксов", color: themes.blue, items: ru_11 },
			// { id: "ru_11p", name: "№11 Практика", color: themes.blue, items: ru_11p, onlyAnswerInQList: true },
			{ id: "ru_12", name: "№12 Пра­во­пи­са­ние глаголов", color: themes.blue, items: ru_12 },
			// { id: "ru_12p", name: "№12 Практика", color: themes.blue, items: ru_12p, onlyAnswerInQList: true },
			{ id: "ru_13", name: "№13 Правописание НЕ", color: themes.blue, items: ru_13 },
			// { id: "ru_13p", name: "№13 Практика", color: themes.blue, items: ru_13p, onlyAnswerInQList: true },
