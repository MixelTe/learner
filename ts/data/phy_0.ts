...
export const phy_0: TestItem[] = [
	...
	new TestItemSelfCheck(45, DBc("Уравнение Менделеева-Клапейрона"), createFormulas("pV = {m}/{'m}RT = 'nRT = NkT", "p = {'rRT}/{'m}")),
	new TestItemSelfCheck(46, DBc("Внутренняя энергии одноатомного идеального газа"), createFormulas("U = {3}/{2}'nRT = {3}/{2}NkT = {3}/{2}{m}/{'m}RT = 'nc_{'v}T = {3}/{2}pV", "\\c_{'v} - удельная теплоёмкость при постоянном объеме газа")),
