...
export const ru_11: TestItem[] = [
	...
	new TestItemSelfCheck(1, DBc("ВА"), DBc("Глаголы, оканчивающиеся на ударяемые -вАть, -вАю, имеют перед суффиксом -ва- ту же гласную, что и в неопределенной форме без этого суффикса").br().text("заливать - залить", "преодолевать - преодолеть").br().text("Исключение: Застрять - застревать")),
	...
	new TestItemSelfCheck(7, DBc("ЕНЬК, ОНЬК"), DBc("Суффиксы не изменяются, не бывает -иньк-, -аньк-", "сухонький, черненький")),
	...
	new TestItemSelfCheck(10, DBc("ИК/ЕК"), DBc("И - если при изменении по падежам И сохраняется", "Е - если И не сохраняется")),
