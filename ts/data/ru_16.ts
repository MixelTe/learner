...
export const ru_16: TestItem[] = [
	...
	new TestItemSelfCheck(1, DBc("Запятые в причастных и деепричастных оборотов"), DBc()
		...
		.text("Причастные обороты - обособляются, если стоят после определяемого слова, а так же с местоименями",
			"Вася, вышедший на улицу, смотрел в даль.",
			"Вышедший на улицу Вася смотрел в даль.",
			"Вышедший на улицу, я смотрел в даль.",
		)
	),
